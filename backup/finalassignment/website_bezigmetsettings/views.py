...
def data_list(request): #for displaying the todo's in a table
    ...
    return render(request, 'website/data_list.html', {'ddata': depthdata, 'bpdata': bpdata, 'frdata': frdata, 'sdata': sdata})
...
def data_list2(request): #for displaying the todo's in a table
    ...
    return render(request, 'website/data_list2.html', {'ddata': depthdata, 'bpdata': bpdata, 'frdata': frdata, 'sdata': sdata})

def settings(request): #for adding other page
    return render(request, 'website/settings.html', {})

def help(request): #for adding other page
