...
class SnippetList(generics.ListCreateAPIView):
    ...
    permission_classes = (permissions.IsAuthenticatedOrReadOnly,)#step4

    def perform_create(self, serializer): #step4
...
class SnippetDetail(generics.RetrieveUpdateDestroyAPIView):
    queryset = Snippet.objects.all()
    serializer_class = SnippetSerializer
    permission_classes = (permissions.IsAuthenticatedOrReadOnly, IsOwnerOrReadOnly,) #step4

class UserList(generics.ListAPIView): #step4
