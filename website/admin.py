...
class EventAdmin(admin.ModelAdmin):
    list_display = ['number', 'day', 'start_time', 'end_time', 'place', 'instructor', 'notes']
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        extra_context['previous_month'] = reverse('admin:website_event_changelist') + '?day__gte=' + str(
            previous_month)
        extra_context['next_month'] = reverse('admin:website_event_changelist') + '?day__gte=' + str(next_month)
